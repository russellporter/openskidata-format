...
} from './RunDifficultyConvention.js'
...
describe('getRunDifficultyConvention', () => {
  it('should return JAPAN for locations in Japan', () => {
    ...
    expect(getRunDifficultyConvention(tokyoGeometry)).toBe(
  ...
  it('should return NORTH_AMERICA for locations in North America', () => {
    ...
    expect(getRunDifficultyConvention(coloradoGeometry)).toBe(
    ...
    expect(getRunDifficultyConvention(bcGeometry)).toBe(
      RunDifficultyConvention.NORTH_AMERICA,
    )
  })
  ...
  it('should return EUROPE for locations in Europe', () => {
    ...
    expect(getRunDifficultyConvention(chamonixGeometry)).toBe(
    ...
    expect(getRunDifficultyConvention(austriaGeometry)).toBe(
      RunDifficultyConvention.EUROPE,
    )
  })
  ...
  it('should return EUROPE as default for other locations', () => {
    ...
    expect(getRunDifficultyConvention(southAmericaGeometry)).toBe(
      RunDifficultyConvention.EUROPE,
    )
  })
  ...
  it('should work with LineString geometry', () => {
    ...
    expect(getRunDifficultyConvention(lineGeometry)).toBe(
      RunDifficultyConvention.EUROPE,
    )
  })
  ...
  it('should work with Polygon geometry', () => {
    ...
    expect(getRunDifficultyConvention(polygonGeometry)).toBe(
      RunDifficultyConvention.NORTH_AMERICA,
    )
  })
})
